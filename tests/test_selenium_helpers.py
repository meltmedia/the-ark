...
class SeleniumHelpersTestCase(unittest.TestCase):
    ...
    @patch("selenium.webdriver.remote.webdriver.WebDriver.execute_script")
    def test_scroll_to_window_position_valid(self, mock_scroll_position):
        self.sh.scroll_to_window_position(y_position=0, x_position=10)
        self.assertTrue(mock_scroll_position.called)

    def test_scroll_to_window_position_invalid(self):
        self.assertRaises(selenium_helpers.ScrollPositionError, self.sh.scroll_to_window_position, None, None)
